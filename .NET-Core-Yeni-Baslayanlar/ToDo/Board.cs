...
namespace Proje_2_Console_ToDo_Uygulaması
{
    public class Board
    {
        ...
        {   //Default Members
            ...
            {
                new TeamMember(10,"sabri derviş"),
                new TeamMember(20,"ecrin tez"),
                new TeamMember(30,"mustafa kalamak"),
                new TeamMember(40,"duru salkım"),
                new TeamMember(50,"cemre şaşmaz"),
                new TeamMember(60,"mert seçil")

            };
            //Default Cards
            cards = new List<Card>()
            {
                new Card("çalışma1","c#",Type.TODO,CardSize.XS,membersList[0]),
                new Card("çalışma2","java",Type.INPROGRESS,CardSize.S,membersList[1]),
                new Card("çalışma3",".Net",Type.DONE,CardSize.L,membersList[2])
            };
        }
        public void AddCard()
        {
